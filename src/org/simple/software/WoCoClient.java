...
public class WoCoClient {
	...
	public void printStats(boolean withPercentiles) {
		...
		System.out.println(elapsedSeconds + ", "+ tput);
		...
		if (withPercentiles) {
			...
			Double averageResTime = respTime.stream()
								.skip(10) // skip first 10 (outliers)
								.limit(respTime.size()-25) // skip lest 15 (outliers)
                .mapToDouble(d -> d)
                .average()
                .orElse(0.0);

			System.out.println("Total time [s], Throughput [ops/s]: "+elapsedSeconds + ", "+ tput);
			System.out.print("Average response time[s]: " + averageResTime);
			System.out.print("\n");
			for (int p=1; p<=100; p++) {
			...
			System.out.println();
			System.out.print("\n");
			System.out.println("Total time [s], Throughput [ops/s], Average response time[s]");
			System.out.print(elapsedSeconds);
			System.out.print("\n");
			System.out.print(tput);
			System.out.print("\n");
			System.out.print(averageResTime);
