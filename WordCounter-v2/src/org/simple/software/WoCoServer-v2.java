...
// 	 */
// 	public boolean receiveData(int clientId, String dataChunk, boolean cMode, int threadCount, AtomicBoolean executed) {
...
// 			final String finalString = line;

// 			if (threadCount>1) {
// 					Runnable r1 = new Runnable(){
// 						public void run(){
// 							Timer t = new Timer();
// 							doWordCount(finalString, wc);
// 							double time = t.check();
...
// 							boolean hasResult = server.receiveData(clientId, result, cMode, threadCount, executed);
...
// 							if (executed.get()) {
// 								System.out.println("Executed 2" + executed.get());
// 								Timer t2 = new Timer();
